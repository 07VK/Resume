                    ...
                    <div class="max-w-4xl mx-auto space-y-12">
                        <div class="reveal">
                            ...
                            <div class="text-slate-600 text-lg leading-relaxed space-y-4">
                                <p>I'm a recent Master's grad from Penn State, where I got to dive deep into the world of AI. My real passion is in the hands-on process of building—taking a complex idea and turning it into a real, working system from the ground up. I've spent my program building everything from multi-agent workflows to computer vision models, and I've learned that I love owning a project from the first line of code to the final deployment. I'm driven by a deep curiosity to solve hard problems and create intelligent, useful applications.</p>
                                <p>My real hobby is diving headfirst into the latest in AI. I'm the person who gets genuinely excited about a new framework release or a groundbreaking research paper. For me, learning isn't just for classes; I love getting my hands dirty with cutting-edge technologies like agentic AI and new LLMs just to see how they work and what I can build with them. That constant curiosity is what drives me.</p>
                            </div>
                        </div>
                        ...
                        <div class="reveal pt-8 border-t border-orange-200" style="transition-delay: 0.4s;">
                            ...
                            <p class="text-slate-600 text-lg leading-relaxed">My enthusiasm for technology extends beyond academics; I am constantly exploring the Gen AI domain in AI/ML. I was the Innovation Club Head Coordinator, created AR applications in a Unity workshop, and ranked in the top 1% of my class. I also volunteered for medical service camps and served as Student Council Head.</p>
                        </div>
                    </div>
                </div>
                <footer class="text-center py-4 border-t border-orange-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`,
        skills: `
            <section id="skills" class="content-section pt-32" style="background-color: var(--section-bg-skills);">
                ...
                <footer class="text-center py-4 border-t border-red-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`,
        experience: `
            <section id="experience" class="content-section pt-32" style="background-color: var(--section-bg-experience);">
                        ...
                        <div class="experience-card card rounded-lg p-6 reveal">
                            ...
                            <div class="description text-slate-600">
                                <ul class="list-disc pl-5 space-y-2">
                                    ...
                                    <li>Provided detailed feedback on algorithmic complexity, 3D modeling in Unity, and Agile methodologies.</li>
                                </ul>
                            </div>
                        </div>
                ...
                <footer class="text-center py-4 border-t border-violet-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`,
        work: `
            <section id="work" class="content-section pt-32" style="background-color: var(--section-bg-work);">
                    ...
                    <div class="max-w-4xl mx-auto space-y-16">
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-8">
                                <div class="card p-6 rounded-lg reveal"><h3 class="text-xl font-bold mb-1 nav-link-dark">AI Resume Tailor</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">CrewAI, FastAPI, React, LangChain</p><p class="mt-2 text-slate-600">Built a smart AI system to customize resumes, boosting ATS scores by 25-40%. Scraped job data and created a smooth pipeline with FastAPI.</p><a href="https://github.com/07VK" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                                <div class="card p-6 rounded-lg reveal" style="transition-delay: 0.1s;"><h3 class="text-xl font-bold mb-1 nav-link-dark">RAG QA Bot</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">PyTorch, DistilBERT, FAISS, FastAPI</p><p class="mt-2 text-slate-600">Crafted an e-commerce chatbot using a 200k+ product dataset. Fine-tuned DistilBERT for sentiment and FAISS for fast retrieval—85% relevance!</p><a href="https://github.com/07VK" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                                <div class="card p-6 rounded-lg reveal" style="transition-delay: 0.2s;"><h3 class="text-xl font-bold mb-1 nav-link-dark">Skin Cancer Detection</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">Python, TensorFlow, PyTorch, YOLOv8</p><p class="mt-2 text-slate-600">Designed a detection system with YOLOv8 and my custom SCSA module, improving precision by 8%+ on the HAM10000 dataset.</p><a href="https://github.com/07VK" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                                <div class="card p-6 rounded-lg reveal" style="transition-delay: 0.3s;"><h3 class="text-xl font-bold mb-1 nav-link-dark">Decentralized Storage</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">React, IPFS, Solidity, MetaMask</p><p class="mt-2 text-slate-600">Created a blockchain web app for secure image sharing using Solidity contracts, React frontend, and IPFS storage.</p><a href="https://github.com/07VK/Decentral-Drive" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                                <div class="card p-6 rounded-lg reveal" style="transition-delay: 0.4s;"><h3 class="text-xl font-bold mb-1 nav-link-dark">Landslide Detection</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">U-Net, Python, DInSAR, OpenCV</p><p class="mt-2 text-slate-600">Developed a 95% accurate U-Net model for landslide detection using Sentinel data and DInSAR for land deformation tracking.</p><a href="https://github.com/07VK/Remote-Sensing-Landslide" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                                <div class="card p-6 rounded-lg reveal" style="transition-delay: 0.5s;"><h3 class="text-xl font-bold mb-1 nav-link-dark">Landslide Prediction</h3><p class="text-sm font-medium" style="color: var(--accent-violet-light);">Python, TensorFlow, ArcGIS</p><p class="mt-2 text-slate-600">Predicted landslides with 98% accuracy using a U-Net model and created a 93% accurate susceptibility map for SR-530.</p><a href="https://github.com/07VK/Landslide-Geo-Atmo-Prediction" target="_blank" class="font-medium nav-link-dark hover:accent-text mt-4 inline-block">View Code <i class="fas fa-arrow-right ml-1"></i></a></div>
                            </div>
                        </div>
                            <div class="pt-8">
                ...
                <footer class="text-center py-4 border-t border-green-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`,
        resume: `
            <section id="resume" class="content-section pt-32" style="background-color: var(--section-bg-resume);">
                    ...
                    <div class="w-full max-w-4xl p-2 bg-white rounded-lg shadow-2xl border border-slate-200">
                        <img src="https://placehold.co/850x1100/f0f9ff/1e293b?text=Resume+Preview" 
                                onerror="this.onerror=null;this.src='https://placehold.co/850x1100/f0f9ff/1e293b?text=Resume+Preview'"
                                alt="Preview of Vishnu Koraganji's Resume"
                                class="w-full rounded-md">
                    </div>
                    <a href="https://github.com/07VK/your-repo/raw/main/Vishnu_Koraganji_Resume.pdf" target="_blank" class="mt-8 inline-block bg-blue-600 text-white font-bold py-4 px-8 rounded-lg text-lg hover:bg-blue-700 transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transform hover:-translate-y-1">
                        <i class="fas fa-download mr-2"></i> Download CV
                    </a>
                </div>
                <footer class="text-center py-4 border-t border-blue-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`,
        contact: `
            <section id="contact" class="content-section pt-32" style="background-color: var(--section-bg-contact);">
                ...
                <footer class="text-center py-4 border-t border-lime-200"><p class="text-sm text-slate-500 font-medium">© 2025 Vishnu Koraganji. Built with AI-driven passion!</p></footer>
            </section>`
    };
});